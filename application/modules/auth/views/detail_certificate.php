<div class="page-content">
    ...
    <div class="content">
        ...
        <div class="page-title">
            ...
            <h3><?php echo lang('list_of_subheading')?>&nbsp;<span class="semi-bold"><?php echo lang('users_certificate_subheading');?></span></h3> 
        </div>
        <!-- <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                                ...
                                <div class="grid simple ">                            
                                    <div class="grid-body no-border">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4><?php echo lang('users_certificate_subheading');?></h4>  
                                        ...
                                        <?php echo form_open('auth/search/'.$user->id, array( 'id'=>'search'))?>
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <div class="col-md-2 search_label"><?php echo form_label(lang('index_certificate_title_th'),'certificate_title_search')?></div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addcertificateModal"><i class="icon-plus"></i>&nbsp;<?php echo lang('add_button');?></button>
                                                    </div>
                                                </div>    
                                            </div>
                                        <?php echo form_close()?>

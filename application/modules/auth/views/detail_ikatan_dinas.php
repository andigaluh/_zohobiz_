<div class="page-content">
    ...
    <div class="content">
        ...
        <div class="page-title">
            ...
            <h3><?php echo lang('list_of_subheading')?>&nbsp;<span class="semi-bold"><?php echo lang('users_ikatan_dinas_subheading');?></span></h3> 
        </div>
        <!-- <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                                ...
                                <div class="grid simple ">                            
                                    <div class="grid-body no-border">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4><?php echo lang('users_ikatan_dinas_subheading');?></h4>  
                                        ...
                                        <?php echo form_open('auth/search/'.$user->id, array( 'id'=>'search'))?>
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        <div class="col-md-2 search_label"><?php echo form_label(lang('index_ikatan_dinas_title_th'),'ikatan_dinas_title_search')?></div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addikatan_dinasModal"><i class="icon-plus"></i>&nbsp;<?php echo lang('add_button');?></button>
                                                    </div>
                                                </div>    
                                            </div>
                                        <?php echo form_close()?>
...
<!-- Add ikatan_dinas Modal -->
<div class="modal fade" id="addikatan_dinasModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="overflow:hidden;">
    <div class="modal-dialog" id="modaldialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_ikatan_dinas', 'add_ikatan_dinas')?></h4>
            </div>
            <p class="error_msg" id="MsgBad" style="background: #fff; display: none;"></p>
            <div class="modal-body">
                <?php echo form_open('auth/add_ikatan_dinas/'.$user->id, array('id'=>'formadd'))?> 
...
<script type="text/javascript">
    ...
    function getTable() 
    {
        $('#tabel').load('<?php echo site_url('auth/get_ikatan_dinas/'.$user->id); ?>');
    }
</script>

<div class="page-content">
    ...
    <div class="content">
        ...
        <div class="page-title">
            ...
            <h3><?php echo lang('list_of_subheading')?>&nbsp;<span class="semi-bold"><?php echo lang('users_sti_subheading');?></span></h3> 
        </div>
        <!-- <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                                ...
                                <div class="grid simple ">                            
                                    <div class="grid-body no-border">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4><?php echo lang('users_sti_subheading');?></h4>  
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addstiModal"><i class="icon-plus"></i>&nbsp;<?php echo lang('add_button');?></button>
                                                    </div>
                                                </div>    
                                            </div>
                                        <?php echo form_close()?>
    	...
    	<div class="modal-content">
		    <div class="modal-header">
	      	...
	      	<div class="modal-body">
	        	<?php echo form_open('auth/add_sti/'.$user->id, array('id'=>'formadd'))?> 

<table class="table table-bordered">
    ...
    <?php if ($user_award->num_rows() > 0){
        ...
        <tr>
            ...
            <td valign="middle"><span class="muted"><?php echo getDateFormat($row->app_date);?></span></td>
                ...
                <div class="col-md-9">
                        <div class="input-with-icon right">
                            <div class="input-append success date no-padding">
                                <input type="text" class="form-control" id="registration_date" name="app_date" value="<?php echo getDateFormat($row->app_date)?>">
...
<?php foreach($user_award->result() as $row){?>
<!--Delete Modal-->
<div class="modal fade" id="deleteawardModal<?php echo $row->id?>" tabindex="-1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>

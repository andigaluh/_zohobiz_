<div class="page-content">
            ...
            <div class="col-md-12">
                <div class="grid simple ">                            
                    <div class="grid-body no-border">
                        ...
                        <?php echo form_open(site_url('competency_group/keywords'),array( 'id'=>'search_comp_group'))?>
    ...
    <thead>
        <tr>
            ...
            <th width="10%"><?php echo anchor('competency_group/index/'.$ftitle_param.'/title/'.(($sort_order == 'asc' && $sort_by == 'title') ? 'desc' : 'asc'), lang('index_ftitle_th'));?></th>
            <th width="10%"><?php echo lang('index_action_th');?></th>                                  
        </tr>
    </thead>
    <tbody>
        <?php if($_num_rows > 0) { ?>
            <?php foreach ($competency_group as $user):?>
                <tr>
                    <td valign="middle">
                         <div class="checkbox check-default">
                        ...
                        <div class="row">
                            <div class="col-md-4 page_limit">
                                ...
                                <?php 
                                    ...
                                    echo '&nbsp;'.lang('found_subheading').'&nbsp;'.$num_rows_all.'&nbsp;'.lang('comp_group_subheading');
                                ?>
                                <?php echo form_close();?>
                            </div>
                            <div class="col-md-10">
  ...
  <div class="modal-dialog" id="modaldialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_comp_group', 'add_comp_group')?></h4>
      </div>
      <p class="error_msg" id="MsgBad" style="background: #fff; display: none;"></p>
      <div class="modal-body">
        <?php echo form_open('competency_group/add/', array('id'=>'formadd2'))?> 
...
<script type="text/javascript">
    ...
    function getTable() 
    {
        $('#tabel').load('<?php echo site_url('competency_group/get_table/'); ?>');
    }
	
	function getModal() 
    {
        $('#modal').load('<?php echo site_url('competency_group/get_modal/'); ?>');
    }

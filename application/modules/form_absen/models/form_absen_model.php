...
class Form_absen_model extends CI_Model
{
     ...
     * form_absen
     *
     * @return object form_absen
     * @author Deni
     **/
    public function form_absen()
    {
        $this->trigger_events('form_absen');
        ...
        $this->response = $this->db->get($this->tables['users_keterangan_absen']);

        return $this;
    }

    public function form_absen_input()
    {
        $this->trigger_events('form_absen_input');
        ...
        else
        {
            ...
            $this->db->select(array(
                ...
                $this->tables['organization'].'.title as organization_title',
                $this->tables['position'].'.title as position_title',
                $this->tables['users_keterangan_absen_plafon'].'.hak_cuti as hak_cuti',
                $this->tables['users_keterangan_absen_plafon'].'.id_comp_session as id_comp_session',
            ...
            $this->db->join('organization', 'users_employement.organization_id = organization.id', 'left');
            $this->db->join('position', 'users_employement.position_id = position.id', 'left');
            $this->db->join('users_keterangan_absen_plafon', 'users.id = users_keterangan_absen_plafon.user_id', 'left');
            $this->db->join('comp_session', 'users_keterangan_absen_plafon.id_comp_session = comp_session.id', 'left');
    ...
    public function get_org_id()
    {
        ...
        else
        {
            ...
            $this->db->join('users_keterangan_absen', 'users.id = users_keterangan_absen.user_id', 'left');
            $this->db->join('users_employement', 'users.id = users_employement.user_id', 'left');
        }
    ...
    public function delete($id)
    {
        ...
        // delete organization from users_keterangan_absen table
        $this->db->delete($this->tables['users_keterangan_absen'], array('id' => $id));
    ...
    public function create_($user_id = FALSE, $additional_data = array())
    {
        ...
        if (!empty($additional_data)) $data = array_merge($this->_filter_data($this->tables['users_keterangan_absen'], $additional_data), $data);

        $this->trigger_events('extra_group_set');

        // insert the new form_absen
        $this->db->insert($this->tables['users_keterangan_absen'], $data);

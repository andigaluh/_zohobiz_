                  ...
                  <div class="row column-seperation">
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="row form-row">
                        ...
                        <div class="col-md-9">
                          <textarea name="notes" class="custom-txtarea-form" placeholder="Note supervisor isi disini"><?php echo $user->note_app_lv1 ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>                  
                    ...
                    <div class="col-md-4 text-center">
                      <div class="row wf-cuti">
                        <div class="col-md-12">
                          ...
                          <?php }else{ ?>
                          <p class="wf-approve-hr">(Personalia)</p>
                          <?php } ?>
                        </div>
                      </div>
                    </div>

...
class Form_training_model extends CI_Model
{
     ...
     * form_training
     *
     * @return object form_training
     * @author Deni
     **/
    public function form_training()
    {
        $this->trigger_events('form_training');
        ...
        else
        {
            ...
            $this->db->select(array(
                $this->tables['users_training'].'.*',
               // $this->tables['users_training'].'.id as id',
                $this->tables['users_training'].'.id as form_training_id',
        ...
        $this->response = $this->db->get($this->tables['users_training']);

        return $this;
    }

    public function form_training_input()
    {
        $this->trigger_events('form_training_input');
   ...
   public function render_emp()
    ...
    public function render_penyelenggara()
    {
        $this->trigger_events('form_cuti');
        ...
        else
        {
            //default selects
            $this->db->select(array(
                $this->tables['penyelenggara'].'.*',
                $this->tables['penyelenggara'].'.id as id',
                $this->tables['penyelenggara'].'.id as penyelenggara_id',
        ...
        $this->response = $this->db->get($this->tables['penyelenggara']);


        return $this;
    }

    public function render_pembiayaan()
    {
        $this->trigger_events('form_cuti');
        ...
        else
        {
            //default selects
            $this->db->select(array(
                $this->tables['pembiayaan'].'.*',
                $this->tables['pembiayaan'].'.id as id',
                $this->tables['pembiayaan'].'.id as pembiayaan_id',
        ...
        $this->response = $this->db->get($this->tables['pembiayaan']);
    ...
    {
        $this->trigger_events('pre_update_frm_training');

        $frm_training = $this->frm_training($id)->row();
        ...
        if ($this->db->trans_status() === FALSE)
        {
            ...
            $this->trigger_events(array('post_update_frm_training', 'post_update_frm_training_unsuccessful'));

...
class grade extends MX_Controller {
    ...
    function __construct()
    {
        ...
        $this->load->model('grade_model','grade_model');
    }

    var $title = 'Education Group';
    var $limit = 100000;
    var $controller_name = 'grade';
    var $model_name = 'grade_model';
    var $id_table = 'id';
    var $list_view = 'grade/index';
    ...
    function index($id=NULL)
    {
        ...
        {
            $data['url_ajax_list'] = site_url('grade/ajax_list');
            $data['url_ajax_add'] = site_url('grade/ajax_add');
            $data['url_ajax_edit'] = site_url('grade/ajax_edit');
            $data['url_ajax_delete'] = site_url('grade/ajax_delete');
            $data['url_ajax_update'] = site_url('grade/ajax_update');

            $this->_render_page('grade/index',$data);
        }
    }

    public function ajax_list()
    {
        $list = $this->grade_model->get_datatables();
        $data = array();
        $no = $_POST['start'];
        foreach ($list as $val) {
            $no++;
        ...
        $output = array(
                        ...
                        "recordsFiltered" => $this->grade_model->count_filtered(),
                        "data" => $data,
                );
    ...
    public function ajax_add()
    {
        ...
        $insert = $this->grade_model->save($data);
    ...
    public function ajax_delete($id)
    {
        ...
        $this->grade_model->update(array('id' => $id), $data);
        echo json_encode(array("status" => TRUE));
    }
    ...
    public function ajax_update()
    {
        ...
        $this->grade_model->update(array('id' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }
    ...
    function _render_page($view, $data=null, $render=false)
    {
        ...
        if ( ! $render)
        {
            ...
            if (in_array($view, array('grade/index')))
            {

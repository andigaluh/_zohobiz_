...
class groups extends MX_Controller {
    ...
    var $limit = 100000;
    var $controller_name = 'groups';
    var $model_name = 'groups_model';
    var $id_table = 'id';
    var $list_view = 'groups/index';
    ...
    function index($id=NULL)
    {
        ...
        {
            $data['url_ajax_list'] = site_url('groups/ajax_list');
            $data['url_ajax_add'] = site_url('groups/ajax_add');
            $data['url_ajax_edit'] = site_url('groups/ajax_edit');
            $data['url_ajax_delete'] = site_url('groups/ajax_delete');
            $data['url_ajax_update'] = site_url('groups/ajax_update');

            $this->_render_page('groups/index',$data);
        }
    }
    ...
    public function ajax_delete($id)
    {
        $data = array(
                ...
                'deleted_user_id' => GetUserID()
            );
        $this->groups_model->update(array('id' => $id), $data);
        echo json_encode(array("status" => TRUE));
    }
    ...
    public function ajax_update()
    {
        ...
        $this->groups_model->update(array('id' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }
    ...
    function _render_page($view, $data=null, $render=false)
    {
        ...
        if ( ! $render)
        {
            ...
            if (in_array($view, array('groups/index')))
            {
                ...
                $this->template->add_js('groups.js');
